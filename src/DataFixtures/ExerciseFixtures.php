...
class ExerciseFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        //     $exercise->setClassroom($classroom);
        // } else {
        //     $exercise->setClassroom($classroom);
        // }
        ...
        //     $user->setPassword('$argon2i$v=19$m=16,t=2,p=1$OGV5VmNnbm1kNTRzYlpWWQ$BjR4kkRl8t7d4I5/pqj+jg'); // Rôle de professeur
        ...
        // $exercise->setExerciseFile($exerciseFile);
