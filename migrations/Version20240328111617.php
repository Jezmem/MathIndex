...
final class Version20240328111617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercise CHANGE id id VARCHAR(255) NOT NULL, CHANGE exercisie_file_id exercise_file_id INT NOT NULL, CHANGE duratoin duration DOUBLE PRECISION NOT NULL');
        ...
        $this->addSql('ALTER TABLE exercise_skill ADD exercise_id_id VARCHAR(255) NOT NULL, ADD skill_id_id INT NOT NULL, DROP exercise_id, DROP skill_id');
        $this->addSql('ALTER TABLE exercise_skill ADD CONSTRAINT FK_7B0B13B55A726995 FOREIGN KEY (exercise_id_id) REFERENCES exercise (id)');
        $this->addSql('ALTER TABLE exercise_skill ADD CONSTRAINT FK_7B0B13B55A6C0D6B FOREIGN KEY (skill_id_id) REFERENCES skill (id)');
        $this->addSql('CREATE INDEX IDX_7B0B13B55A726995 ON exercise_skill (exercise_id_id)');
        $this->addSql('CREATE INDEX IDX_7B0B13B55A6C0D6B ON exercise_skill (skill_id_id)');
        $this->addSql('ALTER TABLE skill CHANGE course_id course_id_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE thematic CHANGE course_id course_id_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercise CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE duration duratoin DOUBLE PRECISION NOT NULL, CHANGE exercise_file_id exercisie_file_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE exercise_skill ADD skill_id INT NOT NULL, DROP exercise_id_id, CHANGE skill_id_id exercise_id INT NOT NULL');
        $this->addSql('ALTER TABLE skill DROP FOREIGN KEY FK_5E3DE47796EF99BF');
        $this->addSql('DROP INDEX IDX_5E3DE47796EF99BF ON skill');
        $this->addSql('ALTER TABLE skill CHANGE course_id_id course_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE thematic CHANGE course_id_id course_id INT NOT NULL');
    }
}
